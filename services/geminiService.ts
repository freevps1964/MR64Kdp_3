...
/**
 * Converte i dati PCM raw (24kHz, 1 canale, 16 bit) in un file WAV valido aggiungendo un header.
 */
export const pcmToWav = (pcmData: ArrayBuffer, sampleRate: number = 24000): ArrayBuffer => {
    const numChannels = 1;
